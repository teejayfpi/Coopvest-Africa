    ...
    return pw.Container(
      ...
      child: pw.Row(
        children: [
          ...
          pw.Expanded(flex: 2, child: pw.Text('Amount', style: const pw.TextStyle(fontSize: 10, fontWeight: pw.FontWeight.bold), textAlignment: pw.TextAlignment.end)),
        ],
      ),
    );
  }
            ...
            children: [
              ...
              pw.Expanded(
                ...
                child: pw.Text(
                  ...
                  textAlignment: pw.TextAlignment.end,
                ),
              ),
            ],
          ),
