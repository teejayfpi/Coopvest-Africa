...
class _QRScannerScreenState extends ConsumerState<QRScannerScreen> {
  ...
  Future<void> _processScannedQR(String rawValue) async {
    ...
    try {
      ...
      try {
        final Map<String, dynamic> qrData = json.decode(rawValue) as Map<String, dynamic>;
        qrId  = qrData['qrId']  as String? ?? '';
        loanId = qrData['loanId'] as String? ?? '';
      } catch (_) {
      ...
      final lookupPath = qrId.isNotEmpty ? '/loans/qr/$qrId' : '/loans/$loanId';
