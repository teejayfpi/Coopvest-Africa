...
class ReplicatedDashboardScreen extends ConsumerStatefulWidget {
  const ReplicatedDashboardScreen({super.key});

  @override
  ConsumerState<ReplicatedDashboardScreen> createState() => _ReplicatedDashboardScreenState();
}

class _ReplicatedDashboardScreenState extends ConsumerState<ReplicatedDashboardScreen> {
  @override
  void initState() {
    super.initState();
